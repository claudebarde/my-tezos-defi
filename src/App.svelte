    ...
    try {
      ...
      if (defiData) {
        ...
        if (defiData.investments) {
          // TEST
          defiData.investments["SMAK-XTZ-KUSD"] = {
            id: "SMAK-XTZ-KUSD",
            platform: "smak",
            address: "KT1TN29nQ45FPoXXv2MWb6TNEKJviVrBnB5z",
            decimals: 6,
            info: [],
            alias: "XTZ-kUSD Farm",
            icons: ["XTZ", "kUSD"],
          ...
          defiData.investments["SMAK-XTZ-SMAK"] = {
            id: "SMAK-XTZ-SMAK",
            platform: "smak",
            address: "KT1FN2uavvys9LsEFh2rBBck6iKLXifyfJmc",
            decimals: 6,
            info: [],
            alias: "XTZ-SMAK Farm",
            icons: ["XTZ", "SMAK"],
          ...
          defiData.investments["SMAK-XTZ-USDTZ"] = {
            id: "SMAK-XTZ-USDTZ",
            platform: "smak",
            address: "KT1GaN4ZHdHNwmQAJqueAz14uvF8BnSujGjV",
            decimals: 6,
            info: [],
            alias: "XTZ-USDtz Farm",
            icons: ["XTZ", "USDtz"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["SMAK-XTZ-PLENTY"] = {
            id: "SMAK-XTZ-PLENTY",
            platform: "smak",
            address: "KT1Dajw5d2iJnd1dQp8PKHtsjkCEheK7GH7g",
            decimals: 6,
            info: [],
            alias: "XTZ-Plenty Farm",
            icons: ["XTZ", "PLENTY"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["SMAK-XTZ-BTCTZ"] = {
            id: "SMAK-XTZ-BTCTZ",
            platform: "smak",
            address: "KT1TWyLZJ3B1uP7RWkCBJrhascUTPnzdNuXR",
            decimals: 6,
            info: [],
            alias: "XTZ-BTCtz Farm",
            icons: ["XTZ", "BTCtz"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["SMAK-XTZ-HDAO"] = {
            id: "SMAK-XTZ-HDAO",
            platform: "smak",
            address: "KT19sefWDyQEgHKdfLLBWJs7tajX5tRECQog",
            decimals: 6,
            info: [],
            alias: "XTZ-hDAO Farm",
            icons: ["XTZ", "hDAO"],
          ...
          defiData.investments["SMAK-XTZ-QUIPU"] = {
            id: "SMAK-XTZ-QUIPU",
            platform: "smak",
            address: "KT1HZjtxM6PXmjyy8TckGxDYjZwSxa2AnoRd",
            decimals: 6,
            info: [],
            alias: "XTZ-QUIPU Farm",
            icons: ["XTZ", "QUIPU"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["SMAK-XTZ-CRUNCH"] = {
            id: "SMAK-XTZ-CRUNCH",
            platform: "smak",
            address: "KT1J3Frj3ZuVRJTTVvBDF4HpX4rBjMpmgUQy",
            decimals: 6,
            info: [],
            alias: "XTZ-CRUNCH Farm",
            icons: ["XTZ", "CRUNCH"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["SMAK-XTZ-Ctez"] = {
            id: "SMAK-XTZ-Ctez",
            platform: "smak",
            address: "KT1PjLbZQoCkcY6GqFwhF73v4CDEJbgUXLcs",
            decimals: 6,
            info: [],
            alias: "XTZ-Ctez Farm",
            icons: ["XTZ", "Ctez"],
          ...
          defiData.investments["SMAK-XTZ-ETHtz"] = {
            id: "SMAK-XTZ-ETHtz",
            platform: "smak",
            address: "KT1DKGLZ8xZ2zTMXJdCwSrZZsLV4oPLUvG6B",
            decimals: 6,
            info: [],
            alias: "XTZ-ETHtz Farm",
            icons: ["XTZ", "ETHtz"],
            rewardToken: "SMAK",
            liquidityToken: true
          };
          defiData.investments["KDAO-KUSD-UUSD"] = {
            id: "KDAO-KUSD-UUSD",
            platform: "kdao",
            address: "KT1VTA694ZHFQPtxg76HzY7gHdvi7idYEYje",
            decimals: 18,
            info: [],
            alias: "kUSD/uUSD Flat Curve LP Farm",
            icons: ["kUSD", "uUSD"],
            rewardToken: "kDAO",
            liquidityToken: true
          };
